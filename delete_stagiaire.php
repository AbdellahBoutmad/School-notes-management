            ...
            <div class="result">
                <?php
                    ...
                    if ($stagiaires) {
                        ...
                        echo "<tr><th>Num</th><th>Firstname</th><th>Last Name</th><th>Class</th><th>delete</th></tr>";
                        foreach ($stagiaires as $stagiaire) {
                            echo "<tr>";
                            echo "<td>" . $stagiaire['num_ins']. "</td>";
                            echo "<td>" . $stagiaire['nom_stg']. "</td>";
                            echo "<td>" . $stagiaire['prenom_stg']. "</td>";
                            echo "<td>" . $stagiaire['class_stg']. "</td><td><button class='btn btn-danger' ><a name='delete_stg' style='color:white;' href='confirme.php?id=".$stagiaire['num_ins']."'>delete stagiaire</a></button></td>";
                            echo "</tr>";
                        }
                        echo "</table>";
                    } else {
